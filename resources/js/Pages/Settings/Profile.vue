            ...
            <div class="iq-card">
              ...
              <div class="iq-card-body p-0">
                <ul class="profile-img-gallary d-flex flex-wrap p-0 m-0">
                  ...
                  <li class="col-md-4 col-6 pl-1 pr-0 pb-0">
                    <a href="javascript:void();"
                      ><img
                ...
                <ul class="pages-lists m-0 p-0">
                  <li class="d-flex mb-4 align-items-center">
                    ...
                    <div class="media-support-info ml-3">
                      ...
                      <p class="mb-0">Creativity Design</p>
                    </div>
                  ...
                  <li class="d-flex align-items-center">
                    ...
                    <div class="media-support-info ml-3">
                      <h6>Latest News</h6>
                      <p class="mb-0">Line information</p>
                    </div>
                    <div class="add-suggestion">
                      <a href="javascript:void();" class="text-warning"
                        ><i class="ri-star-half-line"></i
                          ...
                          <div class="dropdown">
                            ...
                            >
                              <a href="#" class="text-secondary"
                                >29 mins <i class="ri-more-2-line ml-3"></i
                              ></a>
                            </span>
                    ...
                    <div class="comment-area p-3">
                      ...
                      >
                        <div class="d-flex align-items-center">
                          <div
                            class="d-flex align-items-center feather-icon mr-3"
                          >
                            <a href="javascript:void();"
                      ...
                      <div class="d-flex flex-wrap">
                        ...
                        >
                          <div class="dropdown">
                            ...
                            >
                              <a href="#" class="text-secondary"
                                >1 hr <i class="ri-more-2-line ml-3"></i
                              ></a>
                            </span>
                            <div class="dropdown-menu dropdown-menu-right p-0">
                              <a class="dropdown-item" href="#"
                      ...
                      >
                        <div class="d-flex align-items-center">
                          <div
                            class="d-flex align-items-center feather-icon mr-3"
                          >
                            <a id="clickme" href="javascript:void();"
                              ><i class="ri-heart-line"></i
                            ></a>
                            <span class="ml-1">140</span>
                          </div>
                  ...
                  <div class="iq-card-header d-flex justify-content-between">
                    ...
                    >
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right p-0">
                          <a class="dropdown-item" href="#"
                            ><i class="ri-user-unfollow-line mr-2"></i>View</a
                          >
                          <a class="dropdown-item" href="#"
                            ><i class="ri-close-circle-line mr-2"></i>Delete</a
                          >
                          <a class="dropdown-item" href="#"
                      ...
                      <li>
                        ...
                        <div class="d-inline-block w-100">
                          <p>
                            ...
                            <a href="#">gummi bears</a>gummi bears jelly
                            lollipop apple
                          </p>
                          <div class="iq-media-group">
                            <a href="#" class="iq-media">
              ...
              <div class="tab-pane fade" id="profile-friends" role="tabpanel">
                <div class="iq-card">
                  ...
                  <div class="iq-card-body">
                        ...
                        >
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right p-0">
                              ...
                              >
                              <a class="dropdown-item" href="#"
                                ><i class="ri-lock-line mr-2"></i>block</a
                              >
                            </div>
                          </div>
                        </div>
                    ...
                    <a href="javascript:void();" class="btn btn-primary d-block"
                ...
                <div class="iq-card">
                  ...
                  <div class="iq-card-body">
                    ...
                    <div class="mt-2">
                      <h6>Email:</h6>
                      <p>
                        <a href="mailto:nikjone@gmail.com">
                          nikjone@gmail.com</a
                        >
                      </p>
                    </div>
              ...
              <div class="iq-card-body">
                <div class="about-info m-0 p-0">
                  <div class="row">
                    ...
                    <div class="col-9">
                      <a href="mailto:nikjone@demoo.com"> nikjone@demoo.com </a>
                    </div>
                    <div class="col-3">Phone:</div>
                    <div class="col-9">
                      <a href="#">001 2351 256 12</a>
                    </div>
