      ...
      <div class="col-sm-6 col-md-6 col-lg-4">
        <div class="iq-card iq-card-block iq-card-stretch iq-card-height-half">
          <div class="iq-card-body p-0">
            <div class="p-3 bg-primary dark-icon b-3 rounded position-relative">
              <div class="d-flex align-items-center justify-content-between">
                <div
                  class="icon iq-icon-box bg-primary dark-icon rounded border"
                  data-wow-delay="0.2s"
                >
        ...
        <div class="iq-card iq-card-block iq-card-stretch iq-card-height-half">
          <div class="iq-card-body p-0">
            <div class="p-3 bg-info mb-3 rounded position-relative">
              <div class="d-flex align-items-center justify-content-between">
                <div
                  class="icon iq-icon-box bg-info rounded border"
                  data-wow-delay="0.2s"
                >
                  <i class="ri-user-fill"></i>
                </div>
              ...
              <li class="mb-4">
                <div class="d-flex align-items-center justify-content-between">
                  <div class="media align-items-center">
                    <div
                      class="iq-bg-primary dark-icon-light rounded icon-date"
                      data-wow-delay="0.2s"
                    >
                      <div class="date-meta">
                  ...
                  <h6 class="text-primary">
                    +123.3<i class="ri-arrow-up-fill pl-2"></i>
                  </h6>
                </div>
              </li>
              <li class="mb-4">
                <div class="d-flex align-items-center justify-content-between">
                  <div class="media align-items-center">
                    <div
                      class="iq-bg-success rounded icon-date"
                      data-wow-delay="0.2s"
                    >
                      <div class="date-meta">
                        <h3 class="date"><b>15</b></h3>
                  ...
                  <h6 class="text-danger">
                    -80.9<i class="ri-arrow-down-fill pl-2"></i>
                  </h6>
                </div>
              </li>
              <li class="mb-4">
                <div class="d-flex align-items-center justify-content-between">
                  <div class="media align-items-center">
                    <div
                      class="iq-bg-danger rounded icon-date"
                      data-wow-delay="0.2s"
                    >
                      <div class="date-meta">
                        <h3 class="date"><b>15</b></h3>
                  ...
                  <h6 class="text-success">
                    +95.42<i class="ri-arrow-up-fill pl-2"></i>
                  </h6>
                </div>
              </li>
              <li>
                <div class="d-flex align-items-center justify-content-between">
                  <div class="media align-items-center">
                    <div
                      class="iq-bg-info rounded icon-date"
                      data-wow-delay="0.2s"
                    >
                      <div class="date-meta">
                        <h3 class="date"><b>15</b></h3>
                  ...
                  <h6 class="text-info">
                    -65.89<i class="ri-arrow-down-fill pl-2"></i>
                  </h6>
                </div>
              </li>
            </ul>
          ...
          <div class="iq-card-body">
            ...
            >
              ...
              <div>
                ...
                <span class="h4 text-success mb-0 counter d-inline-block w-100"
                  >25,281</span
                >
              </div>
            </div>
          ...
          <div class="iq-card-body">
            ...
            >
              ...
              <div>
                ...
                <span class="h4 text-danger mb-0 counter d-inline-block w-100"
                  >12,396</span
                >
              </div>
            </div>
          ...
          <div class="iq-card-body iq-box-relative">
            ...
            >
              ...
              <div>
                ...
                <span class="h4 text-warning mb-0 counter d-inline-block w-100"
                  >28,258</span
                >
              </div>
            </div>
                    ...
                    <td>
                      <div class="iq-media-group">
                        <a href="#" class="iq-media">
                          <img
                            class="img-fluid avatar-30 rounded-circle"
