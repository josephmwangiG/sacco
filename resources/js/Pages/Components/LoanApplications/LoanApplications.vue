                        ...
                        <div class="row justify-content-between mt-3">
                            <div id="user-list-page-info" class="col-md-6">
                                <span
                                    >Showing 1 to
                                    {{
                                        loanApplications.total > 10
                                            ? "10"
                                            : loanApplications.total
                                    }}
                                    of
                                    {{ loanApplications.total }} entries</span
                                >
                            </div>
                            <div class="col-md-6">
