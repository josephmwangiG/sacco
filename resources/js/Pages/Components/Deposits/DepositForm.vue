                ...
                <form @submit.prevent="saveForm()">
                    <div class="modal-body modal-div">
                        <div class="new-user-info">
                            ...
                            <div class="row collapse" id="bank_div">
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div
                                        class="text-danger"
                                        v-if="form.errors.cheque_date"
                                    >
                                        <small>{{
                                            form.errors.cheque_date
                                        }}</small>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div
                                        class="text-danger"
                                        v-if="form.errors.cheque_number"
                                    >
                                        <small>{{
                                            form.errors.cheque_number
                                        }}</small>
                                    </div>
                                </div>
                            </div>
...
function saveForm() {
    if (props.action == "Edit") {
        ...
        props.form.post(route("deposits.store"), {
            onSuccess: () => {
                props.form.reset();
                document.getElementById("closeModal").click();
            },
