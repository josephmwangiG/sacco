    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="formModal">{{ action }} Branch.</h5>
          <button
            type="button"
            class="close"
            data-dismiss="modal"
            ...
            <div class="new-user-info">
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  />
                  <div class="text-danger" v-if="form.errors.branch_code">
                    <small>{{ form.errors.branch_code }}</small>
                  </div>
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-sm-6">
                  ...
                  <div class="text-danger" v-if="form.errors.country">
                ...
                <div class="form-group col-md-6">
                  ...
                  />
                  <div class="text-danger" v-if="form.errors.town">
