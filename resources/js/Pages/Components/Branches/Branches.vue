          ...
          <div class="iq-card-body">
              ...
              >
                ...
                <tbody>
                  <tr v-for="(branch, index) in branches.data" :key="index">
                    ...
                    <td>{{ branch.created_at.substring(0, 10) }}</td>
                    <td>
                      <div class="flex align-items-center list-user-action">
                        ...
                        <a
                          ...
                          data-toggle="modal"
                          data-placement="top"
                          @click="url = route('branches.destroy', branch.id)"
            ...
            <div class="row justify-content-between mt-3">
              <div id="user-list-page-info" class="col-md-6">
                <span
                  >Showing 1 to
                  {{ branches.total > 10 ? "10" : branches.total }} of
                  {{ branches.total }} entries</span
                >
              </div>
              <div class="col-md-6">
                <nav aria-label="Page navigation example">
                  <ul class="pagination justify-content-end mb-0">
                    <li
                      ...
                      v-for="(link, ind) in branches.links"
                      :key="ind"
                    >
                      <Link
                        class="page-link"
