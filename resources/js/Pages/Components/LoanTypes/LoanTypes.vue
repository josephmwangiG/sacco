          ...
          <div class="iq-card-body">
              ...
              >
                ...
                <tbody>
                  <tr v-for="(obj, index) in loanTypes.data" :key="index">
                    ...
                    <td>
                      <small>{{ obj.penaltyType.display_name }}</small>
                    </td>
                    <td>{{ obj.penalty_value }}</td>
                    <td>{{ obj.service_fee }}</td>
                    <td>{{ obj.repayment_period }} months</td>
                    <td>
                    ...
                    <td>
                      <div class="flex align-items-center list-user-action">
                        ...
                        <a
                          ...
                          data-toggle="modal"
                          data-placement="top"
                          @click="url = route('loanTypes.destroy', obj.id)"
            ...
            <div class="row justify-content-between mt-3">
              <div id="user-list-page-info" class="col-md-6">
                <span
                  >Showing 1 to
                  {{ loanTypes.total > 10 ? "10" : loanTypes.total }}
                ...
                <nav aria-label="Page navigation example">
                  <ul class="pagination justify-content-end mb-0">
                    <li
                      ...
                      v-for="(link, ind) in loanTypes.links"
                      :key="ind"
                    >
                      <Link
                        class="page-link"
