    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="formModal">{{ action }} Withdrawal.</h5>
          <button
            type="button"
            class="close"
            data-dismiss="modal"
        ...
        <form @submit.prevent="saveForm()">
          <div class="modal-body modal-div">
            <div class="new-user-info">
              ...
              <div
                class="row"
                :class="form.payment_method == 'CASH' ? 'collapse' : ''"
                id="bank_div"
              >
                <div class="form-group col-md-6">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  <label for="withdrawal_date">Date of Withdrawal:</label>
                  <input
                    type="date"
                    class="form-control"
                    id="withdrawal_date"
                  ...
                  />
                  <div class="text-danger" v-if="form.errors.withdrawal_date">
                    <small>{{ form.errors.withdrawal_date }}</small>
                  </div>
                </div>
...
function saveForm() {
  if (props.action == "Edit") {
    props.form.put(route("withdrawals.update", props.item), {
      onSuccess: () => {
        props.form.reset();
    ...
    props.form.post(route("withdrawals.store"), {
      onSuccess: () => {
        props.form.reset();
        document.getElementById("closeModal").click();
      },
