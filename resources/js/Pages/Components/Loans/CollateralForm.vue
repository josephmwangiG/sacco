                        ...
                        <div class="new-user-info">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div
                                        class="text-danger"
                                        v-if="form.errors.valuation_amount"
                                    >
                                        <small>{{
                                            form.errors.valuation_amount
                                        }}</small>
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="valuation_date"
                                    ...
                                    <div
                                        class="text-danger"
                                        v-if="form.errors.valuation_date"
                                    >
                                        <small>{{
                                            form.errors.valuation_date
                                        }}</small>
                                    </div>
                                </div>
