                    ...
                    <div class="iq-card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            >
                                ...
                                <tbody>
                                    <tr
                                        v-for="(obj, index) in guarantors"
                                        :key="index"
                                    >
                                        <td>
                                            {{
                                                obj.loan_application.member.user
                                                    .first_name
                                            }}
                                            {{
                                                obj.loan_application.member.user
                                        ...
                                        <td>
                                            {{
                                                obj.loan_application.loan_type
                                                    .name
                                            }}
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            {{
                                                obj.loan_application.service_fee
                                            }}
                                        </td>
                                        <td>
                                            <span class="active">{{
                                        ...
                                        <td>
                                            {{
                                                obj.loan_application.application_date.substring(
                                                    0,
                                                    10
                                                )
                                            }}
