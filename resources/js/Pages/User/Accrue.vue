<template>
  <EditApplication :id="id" :active="'accrue'">
    <div class="mt-5">
      <div class="card-header bg-primary py-2" @click="shows = 'principle'">
        ...
        >
          ...
          <tbody>
            <tr v-if="pays.payments.length > 0">
              <td>
                {{ pays.payments[pays.payments.length - 1].period }}
              </td>
              <td>
                {{
                  pays.payments[
    ...
    <div class="mt-5">
      <div class="card-header bg-primary py-2" @click="shows = 'interest'">
    ...
    <div class="mt-5">
      <div class="card-header bg-primary py-2" @click="shows = 'penalties'">
