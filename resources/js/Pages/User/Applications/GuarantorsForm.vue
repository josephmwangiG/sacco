            ...
            <div class="new-user-info">
              <div class="row">
                <div class="form-group col-sm-6">
                  ...
                  <select required @change="selectMember($event)" v-model="form.member" class="form-control" id="member">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" required v-model="form.account_number" id="account_number"
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="id_number" v-model="form.id_number"
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="guarantee_amount" v-model="form.guarantee_amount"
                ...
                <div class="form-group col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" v-model="form.notes" placeholder="Short notes"
...
function saveForm() {
  if (props.action == "Edit") {
    props.form.put(route("u.loanApplications.update.guarantors", props.item), {
      onSuccess: (response) => {
        props.form.reset();
    ...
    props.form.post(route("u.loanApplications.store.guarantors", props.id), {
      onSuccess: (response) => {
        props.form.reset();
        document.getElementById("closeModal").click();
      },
