                            ...
                            <div class="dropdown collapse">
                                <span
                                    ...
                                    ><a href="#" class="text-secondary"
                                        >29 mins
                                        <i class="ri-more-2-line ml-3"></i></a
                                ></span>
                                <div
                                ...
                                >
                                    <a class="dropdown-item" href="#"
                                        ><i
                                            class="ri-user-unfollow-line mr-2"
                                        ></i
                                        >Unfollow</a
                                    ><a class="dropdown-item" href="#"
                                        ><i
                                            class="ri-share-forward-line mr-2"
                                        ></i
                                        >Share</a
                                    ><a class="dropdown-item" href="#"
                ...
                <form @submit.prevent="saveForm()">
                  ...
                  <option>South Africa</option> -->
                            ...
                            <div class="form-group col-md-4">
                                ...
                                >
                                    <small>{{
                                        form.errors.date_became_member
                                    }}</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer mt-2 collapse">
